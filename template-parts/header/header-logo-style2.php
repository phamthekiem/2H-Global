...
<div class="header-main">
	<div class="container">
		...
		<div class="header-content mt-4">
			...
			<div class="row align-items-center header-top-right">
				<div class="col-1 d-lg-none"></div>
				<div class="col-4 ml-2 ml-lg-0 col-lg-2 col-xl-1">
					<div class="logo">
						<?php display_logo();?>
					</div>
				</div>
